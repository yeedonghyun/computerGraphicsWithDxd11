...
bool TextureClass::TwoPassInitialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, ID3D11Texture2D* texture)
{
	int width = 0;
	int height = 0;
	...
	// targa 이미지 데이터를 텍스처에 복사합니다.
	deviceContext->UpdateSubresource(m_texture, 0, NULL, texture, rowPitch, 0);
